function experimentSetUp( dataset, expSetIndex, nExpGroup, nExpPerGroup, isGammaInputExternal, isDiagonalHeavy, trainingDataFraction)
% This function creates dataset from the graph.

% dataset: Path to the data generated by graph_generator
% expSetIndex: Index of Experiment Set
% nExpGroup: No. of experiment group per experiment set, an experiment
% group defines the experiments which will be executed together in one
% program run.
% nExpPerGroup: No of experiment per group, 
% isGammaInputExternal: if 1, enter value manually for authority transfer rate otherwise it will be generated following power law, 
% isDiagonalHeavy: if 1 diagonal entries will be heavy
% trainingDataFraction: fraction of data to be used for training
